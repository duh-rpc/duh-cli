...
func TestDiscriminatorVariantFieldRule(t *testing.T) {
	for _, test := range []struct {
		...
		{
			name: "ValidAllVariantsHaveField",
			spec: `openapi: 3.0.0
info:
  title: Test
  version: 1.0.0
      ...
      properties:
        message:
          ...
          description: Error message`,
			expectedExit:   1,
			wantNotContain: "[DISCRIMINATOR_VARIANT_FIELD]",
		},
		{
			name: "InvalidVariantMissingField",
			spec: `openapi: 3.0.0
info:
  title: Test
  version: 1.0.0
    ...
    Error:
      ...
      properties:
        message:
          ...
          description: Error message`,
			expectedExit: 1,
			wantContain:  "[DISCRIMINATOR_VARIANT_FIELD]",
		},
	} {
