...
func TestRPCTypedAdditionalPropertiesRule(t *testing.T) {
	for _, test := range []struct {
		...
		{
			name: "ValidTypedAdditionalProperties",
			spec: `openapi: 3.0.0
info:
  title: Test
  version: 1.0.0
  ...
  schemas:
    ...
    Error:
      ...
      properties:
		...
		{
			name: "ValidAdditionalPropertiesFalse",
			spec: `openapi: 3.0.0
info:
  title: Test
  version: 1.0.0
  ...
  schemas:
    ...
    Error:
      ...
      properties:
		...
		{
			name: "InvalidAdditionalPropertiesTrue",
			spec: `openapi: 3.0.0
info:
  title: Test
  version: 1.0.0
