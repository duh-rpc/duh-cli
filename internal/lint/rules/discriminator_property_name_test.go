...
func TestDiscriminatorPropertyNameRule(t *testing.T) {
      ...
      properties:
        message:
          ...
          description: Error message`,
			expectedExit:   1,
			wantNotContain: "[DISCRIMINATOR_PROPERTY_NAME]",
		},
		{
			name: "InvalidPropertyNameKind",
			spec: `openapi: 3.0.0
info:
  title: Test
  version: 1.0.0
    ...
    Error:
      ...
      properties:
        message:
          ...
          description: Error message`,
			expectedExit: 1,
			wantContain:  "[DISCRIMINATOR_PROPERTY_NAME]",
		},
	} {
