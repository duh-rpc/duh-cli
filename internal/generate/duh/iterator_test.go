...
func TestGeneratedIteratorCompiles(t *testing.T) {
	...
	assert.Contains(t, string(iteratorContent), "type Page[T any] struct")
	assert.Contains(t, string(iteratorContent), "type Iterator[T any] interface")
	assert.Contains(t, string(iteratorContent), "type PageFetcher[T any] interface")
	assert.Contains(t, string(iteratorContent), "type GenericIterator[T any] struct")
	assert.Contains(t, string(iteratorContent), "func NewGenericIterator[T any]")
}
